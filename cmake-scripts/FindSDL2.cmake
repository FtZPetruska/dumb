...
``SDL2_VERSION``
  The version of SDL2 that was found.
...
``SDL2_SDL2_LIBRARY_DEBUG``
  The path to the SDL2 debug library.
``SDL2_SDL2_LIBRARY_RELEASE``
The path to the SDL2 release library.
``SDL2_SDL2main_LIBRARY_DEBUG``
  The path to the SDL2main debug library.
``SDL2_SDL2main_LIBRARY_RELEASE``
  The path to the SDL2main release library.
  ...
  if(NOT TARGET SDL2::SDL2)
    ...
    set_target_properties(
      ...
      PROPERTIES IMPORTED_LOCATION "${SDL2_SDL2_LIBRARY}"
                 ...
                 INTERFACE_LINK_DIRECTORIES "${PC_SDL2_LIBRARY_DIRS}"
                 INTERFACE_LINK_OPTIONS "${PC_SDL2_LDFLAGS_OTHER}")
  endif()
